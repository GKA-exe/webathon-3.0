      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div className="p-6">
              {student.isFirstLogin && student.room === null ? (
                <div className="text-center py-4">
                  <div className="mb-6 bg-blue-50 p-4 rounded-lg border border-blue-100">
                    ...
                    <p className="text-gray-600 mb-4">
                      Welcome to the Narkam! To get started, please request a
                      room allocation.
                    </p>
                  </div>
                  <button
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-amber-700 mt-2">
                          Your request is currently under review by the hostel
                          administration.
                        </p>
                      </div>
                      <div className="ml-4">
                ...
                <ul className="divide-y">
                  <li className="py-3">
                    <div className="flex justify-between">
                      <span className="font-medium text-black font-bold">
                        Warden
                      </span>
        ...
        <div className="fixed inset-0 bg-opacity-30 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full border border-gray-200 shadow-xl">
            <h3 className="text-xl font-bold mb-4 text-black">
              Confirm Room Vacation
            </h3>
            <p className="mb-6 text-gray-700">
              Are you sure you want to submit a room vacation request? This
